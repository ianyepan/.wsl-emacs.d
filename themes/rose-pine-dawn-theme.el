;;; rose-pine-dawn-theme.el --- Rose Pine Dawn Theme -*- lexical-binding: t; -*-
...
(defcustom rose-pine-dawn-box-org-todo t
  "Set box around TODO items in org-mode"
  :type 'boolean
  :group 'rose-pine-dawn)

(defcustom rose-pine-dawn-scale-org-faces t
  "Scale headlines and other org faces"
  :type 'boolean
  :group 'rose-pine-dawn)

(defcustom rose-pine-dawn-invert-hl-todo t
...
(let ((class '((class color) (min-colors 89)))
      ...
      (ms-magenta        "#907aa9")
      (ms-orange         "#ea9d34")
      (ms-lightorange    "#ea9d34")
      (ms-red            "#b4637a")
      (ms-green          "#56949f")
      (ms-blue           "#907aa9")
      (ms-lightred       "#b4637a")
      (ms-lightgreen     "#56949f")
      (ms-lightblue      "#907aa9")
      (ms-red-bg         "#ffdddd")
      (ms-green-bg       "#ddffdd")
      (ms-blue-bg        "#ddedff")
  ...
  (custom-theme-set-faces
   ...
   `(link                                     ((,class (:foreground "#0078d4" :underline t))))
   ...
   `(mode-line                                ((,class (:bold nil :foreground ,fg0 :background ,mode-line-bg))))
   `(mode-line-inactive                       ((,class (:bold nil :foreground ,fg2 :background ,mode-line-bg-alt))))
   ...
   `(magit-diff-context-highlight             ((t (:background ,bg2))))
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,ms-bluegreen
                                                              ,@(when rose-pine-dawn-scale-org-faces (list :height 1.1))))))
   ...
   `(org-todo                                 ((,class (,@(when rose-pine-dawn-box-org-todo (list :box `(:line-width 1 :color ,ms-lightred)))
   ...
   `(org-agenda-date                          ((,class (:foreground ,var ,@(when rose-pine-dawn-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,fg4))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when rose-pine-dawn-scale-org-faces (list :height 1.2))))))
   ...
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when rose-pine-dawn-scale-org-faces (list :height 1.2)))))) ; title
   ...
   `(hl-todo                                  ((t ,@(when rose-pine-dawn-invert-hl-todo (list :inverse-video t)))))
   `(highlight-numbers-number                 ((t (:foreground ,numeric))))
   `(highlight-operators-face                 ((t (:inherit default))))
   `(highlight-symbol-face                    ((t (:background "#f2e9e1"))))
