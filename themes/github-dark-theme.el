;;; github-dark-theme.el --- GitHub Dark Theme -*- lexical-binding: t; -*-

;; Copyright (C) 2020-2021 Ian Y.E. Pan

;; Author: Ian Y.E. Pan
;; URL: https://github.com/ianyepan/github-dark-emacs-theme
;; Version: 0.0.0
...
;;; Commentary:
;; A complete port of the default GitHub Dark theme.

;;; Code:

(deftheme github-dark)

(defcustom github-dark-box-org-todo t
  "Set box around TODO items in org-mode"
  :type 'boolean
  :group 'dark-plus)

(defcustom github-dark-scale-org-faces t
  "Scale headlines and other org faces"
  :type 'boolean
  :group 'dark-plus)

(defcustom github-dark-invert-hl-todo t
...
(let ((class '((class color) (min-colors 89)))
      ...
      (numeric           "#79c0ff")
      (mode-line-bg      "#000000")
      (mode-line-bg-dark "#000000")
      (line-num          "#8b949e")
      (line-num-current  "#c9d1d9")
      (builtin           "#ff7b72")
      (keyword           "#ff7b72")
      (const             "#ffa657")
      (comment           "#8b949e")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-regexp-grouping-backslash      ((,class (:foreground ,gh-lightorange))))
   `(font-lock-regexp-grouping-construct      ((,class (:foreground ,gh-lightorange))))
   ...
   `(cursor                                   ((,class (:background ,gh-bluegreen))))
   ...
   `(minibuffer-prompt                        ((,class (:foreground ,gh-bluegreen :weight normal))))
   `(link                                     ((,class (:foreground "#3794ff"))))
   `(error                                    ((,class (:foreground ,gh-orange))))
   `(warning                                  ((,class (:foreground ,gh-magenta))))
   `(success                                  ((,class (:foreground ,gh-bluegreen))))
   ...
   `(company-tooltip-common                   ((t (:foreground ,gh-blue :bold t))))
   `(company-tooltip-selection                ((t (:background ,bg-hl))))
   `(company-tooltip-annotation               ((t (:foreground ,doc-alt)))) ; parameter hints etc.
   `(company-template-field                   ((t (:inherit region))))

   `(org-level-1                              ((,class (:bold nil :foreground ,gh-bluegreen
                                                              ,@(when github-dark-scale-org-faces (list :height 1.1))))))
   `(org-level-2                              ((,class (:bold nil :foreground ,gh-lightblue))))
   `(org-level-3                              ((,class (:bold nil :foreground ,gh-blue))))
   `(org-level-4                              ((,class (:bold nil :foreground ,gh-bluegreen))))
   `(org-code                                 ((,class (:foreground ,gh-orange))))
   `(org-hide                                 ((,class (:foreground ,fg4))))
   `(org-date                                 ((,class (:underline t :foreground ,var) )))
   `(org-footnote                             ((,class (:underline t :foreground ,fg4))))
   `(org-link                                 ((,class (:underline t :foreground ,type ))))
   `(org-special-keyword                      ((,class (:foreground ,gh-green))))
   ...
   `(org-agenda-date                          ((,class (:foreground ,var ,@(when github-dark-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,fg4))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when github-dark-scale-org-faces (list :height 1.2))))))
   `(org-agenda-done                          ((,class (:foreground ,bg4))))
   `(org-scheduled                            ((,class (:foreground ,type))))
   `(org-scheduled-today                      ((,class (:foreground ,func :weight normal
                                                                    ,@(when github-dark-scale-org-faces (list :height 1.2))))))
   `(org-ellipsis                             ((,class (:foreground ,builtin))))
   `(org-verbatim                             ((,class (:foreground ,gh-lightorange))))
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when github-dark-scale-org-faces (list :height 1.2)))))) ; title
   `(org-document-info                        ((,class (:foreground ,gh-yellow)))) ; author, date etc.
   `(org-document-info-keyword                ((,class (:foreground ,gh-green))))  ; "#+Title", "#+Date" etc.
   ...
   `(magit-bisect-bad                         ((t (:foreground ,gh-red))))
   `(magit-bisect-good                        ((t (:foreground ,gh-green))))
   `(magit-bisect-skip                        ((t (:foreground ,gh-orange))))
   `(magit-blame-date                         ((t (:foreground ,gh-red))))
   `(magit-blame-heading                      ((t (:foreground ,gh-orange :background ,bg3 :extend t))))
   `(magit-branch                             ((,class (:foreground ,gh-blue :weight normal))))
   `(magit-branch-current                     ((t (:foreground ,gh-blue))))
   `(magit-branch-local                       ((t (:foreground ,gh-bluegreen))))
   `(magit-branch-remote                      ((t (:foreground ,gh-green))))
   `(magit-cherry-equivalent                  ((t (:foreground ,gh-magenta))))
   `(magit-cherry-unmatched                   ((t (:foreground ,gh-bluegreen))))
   `(magit-diff-added                         ((t (:foreground ,fg2 :background ,gh-green-bg :extend t))))
   `(magit-diff-added-highlight               ((t (:foreground ,fg3 :background ,gh-green-bghl :extend t))))
   `(magit-diff-removed                       ((t (:foreground ,fg2 :background ,gh-red-bg :extend t))))
   `(magit-diff-removed-highlight             ((t (:foreground ,fg3 :background ,gh-red-bghl :extend t))))
   `(magit-diff-base                          ((t (:foreground ,bg1 :background ,gh-orange :extend t))))
   `(magit-diff-base-highlight                ((t (:foreground ,gh-orange :background ,bg3 :extend t))))
   ...
   `(magit-diff-file-heading-selection        ((t (:foreground ,gh-orange :background ,bg3 :extend t))))
   ...
   `(magit-diff-lines-heading                 ((t (:foreground ,gh-yellow :background ,gh-red :extend t))))
   `(magit-diffstat-added                     ((t (:foreground ,gh-green))))
   `(magit-diffstat-removed                   ((t (:foreground ,gh-orange))))
   `(magit-dimmed                             ((t (:foreground ,comment))))
   `(magit-filename                           ((t (:foreground ,gh-magenta))))
   `(magit-hash                               ((t (:foreground ,comment))))
   `(magit-header-line                        ((t (:inherit nil))))
   `(magit-log-author                         ((t (:foreground ,gh-orange))))
   `(magit-log-date                           ((t (:foreground ,gh-blue))))
   `(magit-log-graph                          ((t (:foreground ,comment))))
   `(magit-mode-line-process                  ((t (:foreground ,gh-orange))))
   `(magit-mode-line-process-error            ((t (:foreground ,gh-red))))
   `(magit-process-ok                         ((t (:inherit success))))
   `(magit-process-ng                         ((t (:inherit error))))
   `(magit-reflog-amend                       ((t (:foreground ,gh-magenta))))
   `(magit-reflog-checkout                    ((t (:foreground ,gh-blue))))
   `(magit-reflog-cherry-pick                 ((t (:foreground ,gh-green))))
   `(magit-reflog-commit                      ((t (:foreground ,gh-green))))
   `(magit-reflog-merge                       ((t (:foreground ,gh-green))))
   `(magit-reflog-other                       ((t (:foreground ,gh-bluegreen))))
   `(magit-reflog-rebase                      ((t (:foreground ,gh-magenta))))
   `(magit-reflog-remote                      ((t (:foreground ,gh-bluegreen))))
   `(magit-reflog-reset                       ((t (:inherit error))))
   `(magit-refname                            ((t (:foreground ,comment))))
   `(magit-section-heading                    ((t (:foreground ,gh-magenta))))
   `(magit-section-heading-selection          ((t (:foreground ,gh-orange :extend t))))
   `(magit-section-highlight                  ((t (:background ,bg3 :extend t))))
   `(magit-sequence-drop                      ((t (:foreground ,gh-red))))
   `(magit-sequence-head                      ((t (:foreground ,gh-blue))))
   `(magit-sequence-part                      ((t (:foreground ,gh-orange))))
   `(magit-sequence-stop                      ((t (:foreground ,gh-green))))
   `(magit-signature-bad                      ((t (:inherit error))))
   `(magit-signature-error                    ((t (:inherit error))))
   `(magit-signature-expired-key              ((t (:foreground ,gh-orange))))
   `(magit-signature-good                     ((t (:inherit success))))
   `(magit-signature-revoked                  ((t (:foreground ,gh-magenta))))
   `(magit-signature-untrusted                ((t (:foreground ,gh-bluegreen))))
   `(magit-tag                                ((t (:foreground ,gh-yellow))))

   `(git-commit-summary                       ((t (:inherit default)))) ; magit commit message face

   `(term                                     ((,class (:foreground ,fg1 :background ,bg1))))
   `(term-color-black                         ((,class (:foreground ,bg3 :background ,bg3))))
   `(term-color-blue                          ((,class (:foreground ,gh-blue :background ,func))))
   `(term-color-red                           ((,class (:foreground ,gh-red :background ,bg3))))
   `(term-color-green                         ((,class (:foreground ,gh-green :background ,bg3))))
   `(term-color-yellow                        ((,class (:foreground ,gh-yellow :background ,var))))
   `(term-color-magenta                       ((,class (:foreground ,gh-magenta :background ,builtin))))
   `(term-color-cyan                          ((,class (:foreground ,gh-bluegreen :background ,str))))
   `(term-color-white                         ((,class (:foreground ,fg1 :background ,fg2))))

   `(diredfl-autofile-name                    ((t (:foreground ,fg0))))
   `(diredfl-compressed-file-name             ((t (:foreground ,gh-yellow))))
   `(diredfl-compressed-file-suffix           ((t (:foreground ,doc-alt))))
   `(diredfl-date-time                        ((t (:foreground ,gh-bluegreen))))
   `(diredfl-deletion                         ((t (:foreground ,gh-red :bold t))))
   `(diredfl-deletion-file-name               ((t (:foreground ,gh-red ))))
   `(diredfl-dir-heading                      ((t (:foreground ,gh-blue :bold t))))
   `(diredfl-dir-name                         ((t (:foreground ,gh-blue))))
   `(diredfl-dir-priv                         ((t (:foreground ,gh-blue))))
   `(diredfl-exec-priv                        ((t (:foreground ,gh-green))))
   `(diredfl-executable-tag                   ((t (:foreground ,gh-green))))
   `(diredfl-file-name                        ((t (:foreground ,fg1))))
   `(diredfl-file-suffix                      ((t (:foreground ,doc-alt))))
   `(diredfl-flag-mark                        ((t (:foreground ,gh-yellow :bold t))))
   `(diredfl-ignored-file-name                ((t (:foreground ,doc-alt))))
   `(diredfl-link-priv                        ((t (:foreground ,gh-magenta))))
   `(diredfl-no-priv                          ((t (:foreground ,fg1))))
   `(diredfl-number                           ((t (:foreground ,gh-orange))))
   `(diredfl-other-priv                       ((t (:foreground ,gh-magenta))))
   `(diredfl-rare-priv                        ((t (:foreground ,fg1))))
   `(diredfl-read-priv                        ((t (:foreground ,gh-yellow))))
   `(diredfl-symlink                          ((t (:foreground ,gh-magenta))))
   `(diredfl-tagged-autofile-name             ((t (:foreground ,fg0))))
   `(diredfl-write-priv                       ((t (:foreground ,gh-red))))
   ...
   `(diff-header                              ((t (:foreground ,gh-bluegreen :background nil))))
   `(diff-file-header                         ((t (:foreground ,fg3 :background nil))))
   `(diff-hunk-header                         ((t (:foreground ,fg4 :background ,bg3))))
   `(diff-added                               ((t (:foreground ,fg2 :background ,gh-green-bg))))
   `(diff-removed                             ((t (:foreground ,fg2 :background ,gh-red-bg))))
   `(diff-changed                             ((t (:foreground ,fg2 :background ,gh-blue-bg))))
   `(diff-refine-added                        ((t (:foreground ,fg3 :background ,gh-green-bghl))))
   `(diff-refine-removed                      ((t (:foreground ,fg3 :background ,gh-red-bghl))))
   `(diff-refine-changed                      ((t (:foreground ,fg3 :background ,gh-blue-bghl))))

   `(ediff-fine-diff-Ancestor                 ((t (:background ,gh-red-bghl))))
   `(ediff-fine-diff-A                        ((t (:background ,gh-red-bghl))))
   `(ediff-fine-diff-B                        ((t (:background ,gh-green-bghl))))
   `(ediff-fine-diff-C                        ((t (:background ,gh-blue-bghl))))
   `(ediff-current-diff-Ancestor              ((t (:background ,gh-red-bg))))
   `(ediff-current-diff-A                     ((t (:background ,gh-red-bg))))
   `(ediff-current-diff-B                     ((t (:background ,gh-green-bg))))
   `(ediff-current-diff-C                     ((t (:background ,gh-blue-bg))))
   ...
   `(sml/charging                             ((t (:foreground ,gh-green :weight normal))))

   `(evil-ex-substitute-matches               ((t (:foreground ,warning :weight normal :strike-through t))))
   `(evil-ex-substitute-replacement           ((t (:foreground ,gh-bluegreen :weight normal))))

   `(hl-todo                                  ((t ,@(when github-dark-invert-hl-todo (list :inverse-video t)))))
   ...
   `(font-latex-math-face                     ((t (:foreground ,gh-blue))))
   `(font-latex-sectioning-0-face             ((t (:foreground ,gh-blue))))
   `(font-latex-sectioning-1-face             ((t (:foreground ,gh-magenta))))
   `(font-latex-sectioning-2-face             ((t (:foreground ,gh-lightorange))))
   `(font-latex-sectioning-3-face             ((t (:foreground ,gh-lightblue))))
   `(font-latex-sectioning-4-face             ((t (:foreground ,gh-lightred))))
   `(font-latex-sectioning-5-face             ((t (:foreground ,gh-lightgreen))))
   `(font-latex-script-char-face              ((t (:foreground ,gh-blue))))
