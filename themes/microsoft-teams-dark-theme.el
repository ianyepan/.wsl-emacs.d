;;; microsoft-teams-dark-theme.el --- Microsoft Teams Theme -*- lexical-binding: t; -*-
...
(deftheme microsoft-teams-dark)

(defcustom microsoft-teams-dark-box-org-todo t
  "Set box around TODO items in org-mode"
  :type 'boolean
  :group 'microsoft-teams-dark)

(defcustom microsoft-teams-dark-scale-org-faces t
  "Scale headlines and other org faces"
  :type 'boolean
  :group 'microsoft-teams-dark)

(defcustom microsoft-teams-dark-invert-hl-todo t
...
(let ((class '((class color) (min-colors 89)))
      (fg0               "#bdbde6")
      (fg1               "#e5e5f1") ; default fg
      (fg2               "#e2e2f6")
      (fg3               "#f4f4fc")
      (fg4               "#f4f4fc")
      (bg0               "#11100f")
      (bg1               "#201f1f") ; default bg
      (bg2               "#292828")
      (bg3               "#323131")
      (bg4               "#484644")
      (bg-hl             "#33344a")
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,ms-bluegreen
                                                              ,@(when microsoft-teams-dark-scale-org-faces (list :height 1.1))))))
   ...
   `(org-todo                                 ((,class (,@(when microsoft-teams-dark-box-org-todo (list :box '(:line-width 1 :color ,ms-lightred)))
   ...
   `(org-agenda-date                          ((,class (:foreground ,var ,@(when microsoft-teams-dark-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,fg4))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when microsoft-teams-dark-scale-org-faces (list :height 1.2))))))
   ...
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when microsoft-teams-dark-scale-org-faces (list :height 1.2)))))) ; title
   ...
   `(hl-todo                                  ((t ,@(when microsoft-teams-dark-invert-hl-todo (list :inverse-video t)))))
...
(provide-theme 'microsoft-teams-dark)
(provide 'microsoft-teams-dark-theme)

;;; microsoft-teams-dark-theme.el ends here
