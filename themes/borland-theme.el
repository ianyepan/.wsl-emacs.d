...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(hl-line                                  ((,class (:inherit region :extend t))))
   ...
   `(vertical-border                          ((,class (:background ,mode-line-bg-dark :foreground ,bg0))))
   ...
   `(company-tooltip-common                   ((t (:foreground "#0000ff" :bold t))))
   `(company-tooltip-common-selection         ((t (:foreground ,builtin :bold t))))
   `(company-tooltip-annotation               ((t (:inherit font-lock-comment-face))))
   `(company-tooltip-selection                ((t (:background ,bg0 :foreground ,fg2))))
   `(company-scrollbar-bg                     ((t (:background "gray75"))))
   `(company-scrollbar-fg                     ((t (:background "gray85"))))
