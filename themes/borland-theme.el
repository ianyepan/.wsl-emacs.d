;;; borland-theme.el --- Inspired by Borland Turbo IDEs -*- lexical-binding: t; -*-

;; Copyright (C) 2026 Ian Y.E. Pan

;; Author: Ian Y.E. Pan
;; URL: https://github.com/ianpan870102/borland-emacs-theme
;; Version: 0.5.0
...
;;; Commentary:
;; Inspired by Borland Turbo IDEs
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(menu                                     ((,class (:foreground ,bg0 :background "#aaaaaa"))))
   `(tty-menu-enabled-face                    ((,class (:foreground ,bg0 :background "#aaaaaa"))))
   ...
   `(flycheck-verify-select-checker           ((,class (:inherit link))))
   `(error                                    ((,class (:foreground ,warning))))
   `(warning                                  ((,class (:foreground ,warning))))
   `(success                                  ((,class (:foreground ,ms-bluegreen))))
   `(dired-directory                          ((t (:foreground ,ms-lightblue :background unspecified))))
   `(line-number                              ((,class (:foreground ,line-num :background unspecified))))
   `(line-number-current-line                 ((,class (:foreground ,ms-lightblue :background unspecified))))
   `(header-line                              ((,class (:inherit nil :foreground ,accent :background ,bg4 :box (:line-width -1)))))

   `(mode-line                                ((,class (:bold nil :foreground ,bg0 :background ,mode-line-bg))))
   `(mode-line-inactive                       ((,class (:bold nil :foreground ,bg0 :background ,mode-line-bg-dark))))
   `(mode-line-buffer-id                      ((,class (:bold t :foreground ,bg0 :background unspecified))))
   `(mode-line-highlight                      ((,class (:foreground ,keyword :box nil :weight normal))))
   `(mode-line-emphasis                       ((,class (:bold t :foreground ,bg0))))
   ...
   `(neo-dir-link-face                        ((t (:foreground ,ms-lightblue :family "Sans Serif"))))
   `(neo-header-face                          ((t (:foreground ,fg0 :family "Sans Serif"))))
   `(neo-banner-face                          ((t (:foreground ,fg0 :family "Sans Serif"))))
   `(neo-root-dir-face                        ((t (:foreground ,fg0 :family "Sans Serif"))))
   `(neo-file-link-face                       ((t (:foreground ,fg0 :family "Sans Serif"))))
   `(neo-expand-btn-face                      ((t (:foreground ,fg0))))
