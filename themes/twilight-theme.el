...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-bisect-bad                         ((t (:foreground ,tw-r))))
   `(magit-bisect-good                        ((t (:foreground ,tw-g))))
   `(magit-bisect-skip                        ((t (:foreground ,const))))
   `(magit-blame-date                         ((t (:foreground ,tw-r))))
   `(magit-blame-heading                      ((t (:foreground ,const :background ,bg3 :extend t))))
   `(magit-branch                             ((,class (:foreground ,tw-b :weight normal))))
   `(magit-branch-current                     ((t (:foreground ,tw-b))))
   `(magit-branch-local                       ((t (:foreground ,tw-b))))
   `(magit-branch-remote                      ((t (:foreground ,tw-g))))
   `(magit-cherry-equivalent                  ((t (:foreground ,tw-r))))
   `(magit-cherry-unmatched                   ((t (:foreground ,tw-b))))
   `(magit-diffstat-added                     ((t (:foreground ,tw-g))))
   `(magit-diffstat-removed                   ((t (:foreground ,const))))
   `(magit-dimmed                             ((t (:foreground ,comment))))
   `(magit-filename                           ((t (:foreground ,tw-r))))
   `(magit-hash                               ((t (:foreground ,comment))))
   `(magit-header-line                        ((t (:inherit nil))))
   `(magit-log-author                         ((t (:foreground ,const))))
   `(magit-log-date                           ((t (:foreground ,tw-b))))
   `(magit-log-graph                          ((t (:foreground ,comment))))
   `(magit-mode-line-process                  ((t (:foreground ,const))))
   `(magit-mode-line-process-error            ((t (:foreground ,tw-r))))
   `(magit-process-ok                         ((t (:inherit success))))
   `(magit-process-ng                         ((t (:inherit error))))
   `(magit-reflog-amend                       ((t (:foreground ,tw-r))))
   `(magit-reflog-checkout                    ((t (:foreground ,tw-b))))
   `(magit-reflog-cherry-pick                 ((t (:foreground ,tw-g))))
   `(magit-reflog-commit                      ((t (:foreground ,tw-g))))
   `(magit-reflog-merge                       ((t (:foreground ,tw-g))))
   `(magit-reflog-other                       ((t (:foreground ,tw-b))))
   `(magit-reflog-rebase                      ((t (:foreground ,tw-r))))
   `(magit-reflog-remote                      ((t (:foreground ,tw-b))))
   `(magit-reflog-reset                       ((t (:inherit error))))
   `(magit-refname                            ((t (:foreground ,comment))))
   `(magit-section-heading                    ((t (:foreground ,tw-r))))
   `(magit-section-heading-selection          ((t (:foreground ,const :extend t))))
   `(magit-section-highlight                  ((t (:background ,bg3 :extend t))))
   `(magit-sequence-drop                      ((t (:foreground ,tw-r))))
   `(magit-sequence-head                      ((t (:foreground ,tw-b))))
   `(magit-sequence-part                      ((t (:foreground ,const))))
   `(magit-sequence-stop                      ((t (:foreground ,tw-g))))
   `(magit-signature-bad                      ((t (:inherit error))))
   `(magit-signature-error                    ((t (:inherit error))))
   `(magit-signature-expired-key              ((t (:foreground ,const))))
   `(magit-signature-good                     ((t (:inherit success))))
   `(magit-signature-revoked                  ((t (:foreground ,tw-r))))
