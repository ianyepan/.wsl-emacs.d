...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-filename                           ((t (:foreground ,ms-green))))
...
(provide-theme 'fluent-edge)
(provide 'fluent-edge-theme)

;;; fluent-edge-theme.el ends here
