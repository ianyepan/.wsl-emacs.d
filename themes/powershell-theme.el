;;; powershell-theme.el --- Inspired by Microsoft's Powershell  -*- lexical-binding: t; -*-

;; Copyright (C) 2020 Ian Y.E. Pan

;; Author: Ian Y.E. Pan
;; URL: https://github.com/ianpan870102/powershell-emacs-theme
;; Version: 0.5.0
...
;;; Commentary:
;; Inspired by Microsoft's Powershell Colors
...
(let ((class '((class color) (min-colors 89)))
      ...
      (ms-magenta        "#ffff00")
      (ms-orange         "#ffff00")
      (ms-lightorange    "#ffff00")
      (ms-red            "#ff0000")
      (ms-green          "#00ff00")
      (ms-blue           "#0099ff")
      (ms-lightred       "#ff0000")
      (ms-lightgreen     "#00ff00")
      (ms-lightblue      "#00cccc")
      (ms-red-bg         "#551b1e")
      (ms-green-bg       "#39422a")
      (ms-blue-bg        "#040e3f")
  ...
  (custom-theme-set-faces
   ...
   `(ivy-current-match                        ((t (:background ,bg-hl :distant-foreground ,fg0 :extend t))))
...
(provide-theme 'powershell)
(provide 'powershell-theme)

;;; powershell-theme.el ends here
